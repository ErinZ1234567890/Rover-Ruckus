...
@Autonomous(name="Sample Aut With Two Crater Side", group="Autonomous")

public class LiftAutSamplingCratorSide extends LinearOpMode {
    DcMotor lift;
    DcMotor leftFront;
    DcMotor rightFront;
    DcMotor leftBack;
...
//11wait @ 5speed
                    ...
                    sample.setPower(.9); //put phone back into position
                    stopRobot(2);
