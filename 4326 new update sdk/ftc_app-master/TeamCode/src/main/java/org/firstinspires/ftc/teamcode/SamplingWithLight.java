...
//import org.firstinspires.ftc.robotcore.external.navigation.V
...
@Autonomous(name="Sample Aut With Light", group="Autonomous")

public class SamplingWithLight extends LinearOpMode {
    DcMotor lift;
    DcMotor leftFront;
    DcMotor rightFront;
    DcMotor leftBack;
    ...
    public void runOpMode() {
        ...
        initVuforia();
//        cam.Instance.SetFlashTorchMode(true);    //commented out
